<div class="grafica2" id="grafica2">
    <div class="grafica2__image">
        <svg id="grafica2-svg" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1915.37 577.33" style="enable-background:new 0 0 1915.37 577.33;" xml:space="preserve">
            <style type="text/css">
                .st0 {
                    opacity: 0.8;
                    fill: none;
    ...
    <div>
        <p class="grafica2__title pb-0 mb-0"> {{ trans('footer.seccion1-title') }}</p>
        <p class="grafica2__subtitle mt-n3">
            {{ trans('footer.seccion1-title2') }}
        </p>
    </div>
    <div class="d-flex justify-content-center">
        <button onclick="window.location='como-iniciar'" class="btn btn-outline-secondary">{{ trans('footer.seccion1-btn') }}</button>
