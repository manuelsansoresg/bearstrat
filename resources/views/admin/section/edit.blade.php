        ...
        <div class="row">
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    {{ Form::open(['route' => ['section.update', $section->id], 'method' => 'PUT', 'files' => true]) }}
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Seccion</label>
                            <input type="text" class="form-control" id="section" name="section" value="{{ $section->section }}">
                            @if($errors)
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="content_esp" id="content_esp" cols="30" rows="50">{!! $section->content_esp !!}</textarea>
                            @if($errors)
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="content_eng" id="content_eng" cols="30" rows="50">{!! $section->content_eng !!}</textarea>
                            @if($errors)
